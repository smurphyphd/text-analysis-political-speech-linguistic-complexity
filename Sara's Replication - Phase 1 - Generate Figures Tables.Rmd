...
here()
getwd()
file.exists(here("dataverse", "phase1", "congressspeech.RData"))

temp_env <- new.env()
load(here("dataverse", "phase1", "congressspeech.RData"), envir = temp_env)
ls(temp_env)
...
here()
getwd()
file.exists(here("dataverse", "phase1", "euspeech.RData"))

temp_env <- new.env()
load(here("dataverse", "phase1", "euspeech.RData"), envir = temp_env)
ls(temp_env)
...
here()
getwd()
file.exists(here("dataverse", "phase1", "parlspeech.Rdata"))

temp_env <- new.env()
load(here("dataverse", "phase1", "parlspeech.Rdata"), envir = temp_env)
ls(temp_env)
